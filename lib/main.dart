...
class _BottomNavigationBar extends StatelessWidget {
    ...
    BottomNavigationBarItem _generateBarItems(String iconText, IconData iconData) {
...
final Widget _currentlyPlayingRow = Container(
    ...
    child:  Row(
            ...
            children: <Widget>[
                Image.asset("images/album_cover_1.png", height: 50, width: 50,),
                Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: <Widget>[
                        Text("Muse - PARTYNEXTDOOR", style: TextStyle(color: Colors.white, fontSize: 15)),
                        Row(
                                children: <Widget>[
                                    IconButton(icon: Icon(Icons.devices, color: Colors.white, size: 20), onPressed: null),
                                    Text("Devices available", style: TextStyle(color: Colors.white, fontSize: 15))
                                ]
                        )
                    ],
                ),
                Column(
                    children: <Widget>[
                        IconButton(icon: Icon(Icons.play_circle_outline, color: Colors.white, size: 40), onPressed: null,)
                    ],
                )
            ],
        ),
